...
ws.onmessage = (event) => {
    ...
    const query = `insert into papertrading (phoneno,price,target,stoploss,amount)values (${res.locals.phoneno},${g},${tar},${sl},${amt})`
    console.log(res.locals.phoneno, g, tar, sl, amt)
